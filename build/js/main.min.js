...
var _initReservation = require("./modules/reservation.js/init-reservation");
// ---------------------------------

window.addEventListener('DOMContentLoaded', function () {
  (0, _initReservation.initResrvation)();
...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./modules/reservation.js/init-reservation":11,"./utils/ios-vh-fix":14}],2:[function(require,module,exports){
"use strict";
...
exports.initResrvation = void 0;
var initResrvation = function initResrvation() {
  var btn = Array.from(document.querySelectorAll('.rooms__btn'));
  var overlay = Array.from(document.querySelectorAll('.rooms__overlay'));
  var card = Array.from(document.querySelectorAll('.rooms__card'));
  btn.forEach(function (item, index) {
    ...
    overlay[index].onclick = function () {
...
exports.initResrvation = initResrvation;
