...
const build = gulp.series(clean, copy, gulp.parallel(compileMinStyles, compileMainMinScripts, optimizePng, optimizeJpg, optimizeSvg));
const dev = gulp.series(clean, copy, gulp.parallel(compileMinStyles, compileMainMinScripts, optimizePng, optimizeJpg, optimizeSvg), syncServer);
const start = gulp.series(clean, copy, gulp.parallel(compileStyles, compileMainScripts), syncServer);
